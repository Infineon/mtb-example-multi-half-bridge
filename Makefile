...
APPNAME=mtb-example-multi-half-bridge
...
DEFINES= TARGET_BOARD=CY8CPROTO_062_4343W TARGET_CY8CPROTO_062_4343W
...
# Ignore from middleware
CY_IGNORE += $(SEARCH_multi-half-bridge)/src/framework/arduino \
			 $(SEARCH_multi-half-bridge)/src/framework/raspberrypi \
			 $(SEARCH_multi-half-bridge)/src/framework/wiced-43xxx \
			 $(SEARCH_multi-half-bridge)/test
